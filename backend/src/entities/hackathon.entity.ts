...
export enum HackathonStatus {
  ...
  MENTOR_SELECTION = 'mentor_selection',
...
export class Hackathon {
  ...
  // Phase 2: Mentor Selection
  @Column('timestamp', { nullable: true })
  mentorSelectionStart: Date;

  @Column('timestamp', { nullable: true })
  mentorSelectionEnd: Date;
  ...
  @OneToMany(() => HackathonRound, (round) => round.hackathon, {
    cascade: true,
  })
