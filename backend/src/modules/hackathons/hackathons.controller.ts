...
export class HackathonsController {
  ...
  async getAdminOverview(@Param('id') id: string) {
    return await this.hackathonsService.getAdminOverview(id);
  }

  @Get(':id/admin-activities')
  @UseGuards(AuthGuard, RolesGuard)
  @Roles(Role.ADMIN, Role.MENTOR)
  async getActivities(@Param('id') id: string) {
    return await this.hackathonsService.getAdminActivities(id);
  }

  @Get(':id/admin-detailed-teams')
  @UseGuards(AuthGuard, RolesGuard)
  @Roles(Role.ADMIN, Role.MENTOR)
  async getAdminDetailedTeams(@Request() req: any, @Param('id') id: string) {
    return await this.hackathonsService.getAdminTeams(id, req.user);
  }

  @Get('submissions/:id/details')
  @UseGuards(AuthGuard, RolesGuard)
  @Roles(Role.ADMIN, Role.MENTOR)
  async getSubmissionDetails(@Request() req: any, @Param('id') id: string) {
    return await this.hackathonsService.getSubmissionDetails(req.user, id);
  }
  ...
  async uploadBanner(@Body() body: { filename: string; contentType: string }) {
    return await this.hackathonsService.getUploadUrl(
      body.filename,
      body.contentType,
    );
  }
  ...
  @UseGuards(AuthGuard, RolesGuard)
  @Roles(Role.ADMIN, Role.MENTOR)
  async getAdminTeamDetails(
    @Request() req: any,
    @Param('teamId') teamId: string,
  ) {
    return await this.hackathonsService.getAdminTeamDetails(req.user, teamId);
  }

  @Get('teams/:teamId')
  @UseGuards(AuthGuard, RolesGuard)
  @Roles(Role.ADMIN, Role.MENTOR)
  async getAdminTeamDetailsFallback(
    @Request() req: any,
    @Param('teamId') teamId: string,
  ) {
    return await this.hackathonsService.getAdminTeamDetails(req.user, teamId);
  ...
  @UseGuards(AuthGuard, RolesGuard)
  @Roles(Role.ADMIN, Role.MENTOR)
  async getTeams(@Request() req: any, @Param('id') id: string) {
    return await this.hackathonsService.getHackathonTeams(req.user, id);
  }
  ...
  async register(
    @Request() req: any,
    @Param('id') id: string,
    @Body() registerDto: RegisterHackathonDto,
  ) {
  ...
  async inviteMember(
    @Request() req: any,
    @Param('id') id: string,
    @Body() memberDto: RegisterMemberDto,
  ) {
  ...
  async removeMember(
    ...
    return await this.hackathonsService.removeMember(
      req.user,
      id,
      registrationId,
    );
  ...
  async revokeInvitation(
    ...
    return await this.hackathonsService.revokeInvitation(
      req.user,
      id,
      invitationId,
    );
  ...
  async assignMentors(
    ...
    return await this.hackathonsService.assignMentors(
      id,
      body.mentorIds,
      body.type,
    );
  ...
  async assignToTeam(
    ...
    return await this.hackathonsService.assignMentorToTeam(
      id,
      mentorId,
      teamId,
    );
  ...
  async submitRound(
    ...
    return await this.hackathonsService.submitRound(
      req.user,
      teamId,
      roundId,
      dto,
  ...
  async evaluateSubmission(
    ...
    return await this.hackathonsService.evaluateSubmission(
      req.user,
      id,
      body.score,
      body.feedback,
  ...
  async submitScore(
    ...
    return await this.hackathonsService.submitScore(
      req.user,
      id,
      body.score,
      body.remarks,
