        ...
        <div className="space-y-12">
            ...
            <div className="bg-zinc-900/30 border border-zinc-900 rounded-[3rem] overflow-hidden">
                <div className="grid grid-cols-12 p-8 border-b border-zinc-900 text-[10px] font-black uppercase tracking-[0.2em] text-zinc-600">
                    ...
                    <div className="col-span-2 text-center">{selectedRound === 'overall' ? 'Overall Points' : 'Round Score'}</div>
                    <div className="col-span-2 text-center">{selectedRound === 'overall' ? 'Trend' : 'Total Progress'}</div>
                </div>
                                ...
                                <div className="col-span-2 flex justify-center">
                                    {selectedRound === 'overall' ? (
                                        ...
                                        <div className="flex flex-col items-center">
                                            ...
                                            <span className="text-[8px] font-black text-zinc-600 uppercase tracking-widest">Running Total</span>
                                        </div>
                                    )}
                                </div>
                            </div>
