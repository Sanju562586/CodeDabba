                        ...
                        <div className="lg:col-span-2 space-y-8">
                            {isEliminated ? (
                                ...
                                <div className="p-20 bg-zinc-900/50 border border-emerald-500/20 border-dashed rounded-[3rem] text-center">
                                    ...
                                    <h3 className="text-2xl font-black italic uppercase text-emerald-400">Signal Received</h3>
                                    <p className="text-zinc-600 max-w-sm mx-auto mt-2">
                                        Your squad has successfully transmitted the payload for this mission. Resubmissions or edits are prohibited.
                                    </p>
                                </div>
                            ) : (
                            ...
                            <div className="p-8 bg-zinc-900 border border-zinc-800 rounded-[2.5rem]">
                                ...
                                <div className="space-y-4">
                                    {submissions.map((sub, idx) => (
                                        <div key={sub.id} className={`p-5 rounded-2xl border transition-all bg-black/40 border-zinc-800`}>
                                            <div className="flex justify-between items-start mb-4">
                                                <div>
                                                    <div className="flex items-center gap-2">
                                                        <h5 className="text-xs font-black italic uppercase">SUBMISSION RECORD</h5>
                                                    </div>
                                            ...
                                            {sub.isScored && (
                                                <div className="mt-4 pt-4 border-t border-zinc-800 space-y-3">
                                                        <span className="text-[10px] font-black text-zinc-500 uppercase tracking-widest px-2">Assessment Results</span>
                                                        <span className="text-lg font-black italic text-emerald-500">{sub.finalScore?.toFixed(1)} <span className="text-[10px] text-zinc-600 uppercase not-italic">Points</span></span>
