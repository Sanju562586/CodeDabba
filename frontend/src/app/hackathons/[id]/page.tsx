                        ...
                        <div className="space-y-12">
                            ...
                            <div className="p-8 bg-zinc-900 border border-zinc-800 rounded-[3rem] space-y-6 sticky top-24">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex justify-between items-center py-3 border-b border-white/5 text-sm">
                                        <span className="font-bold text-zinc-500">ENLISTED SQUADS</span>
                                        <div className="flex flex-col items-end">
                                            <span className="text-white font-black italic text-lg leading-none">{hackathon.teamCount || 0}</span>
                                            {hackathon.maxParticipants && (
                                                <span className="text-[10px] text-zinc-600 font-bold uppercase tracking-widest mt-1">CAP: {hackathon.maxParticipants} PERSONS</span>
                                            )}
                                        </div>
                                    </div>
