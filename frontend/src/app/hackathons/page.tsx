                                    ...
                                    <div className="p-10 flex-1 flex flex-col justify-between">
                                        ...
                                        <div className="flex items-center justify-between pt-8 border-t border-zinc-800">
                                            <div className="flex flex-col">
                                                <span className="text-xl font-black italic text-white leading-none">{h.teamCount || 0}</span>
                                                <span className="text-[10px] font-black uppercase text-zinc-600 tracking-widest mt-1">Squad{(h.teamCount || 0) === 1 ? '' : 's'} Enlisted</span>
                                            </div>
                                            <div className="flex items-center gap-4">
                                                <span className="text-xs font-black uppercase text-zinc-600 tracking-widest text-right">
