                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-6 bg-zinc-900/90 border border-zinc-800 rounded-[2.5rem] backdrop-blur-md shadow-2xl">
                        <div className="flex items-center gap-4 px-6 border-r border-zinc-800">
                            ...
                            <div>
                                ...
                                <p className="text-xs font-black italic">{new Date(hackathon.registrationStart).toLocaleDateString('en-US', { month: 'short', day: 'numeric' })} - {new Date(hackathon.registrationEnd).toLocaleDateString('en-US', { month: 'short', day: 'numeric' })}</p>
                            </div>
                        </div>
                        ...
                        <div className="grid lg:grid-cols-2 gap-12 animate-in fade-in slide-in-from-bottom-6 duration-500">
                            ...
                            <div className="space-y-12">
                                ...
                                {inactiveTeams.length > 0 && (
                                    <div className="space-y-6">
                                        <div className="flex justify-between items-center">
                                            <h2 className="text-xl font-black italic uppercase tracking-tighter flex items-center gap-4 text-red-500">
                                                <Archive className="w-5 h-5" />
                                                Inactive Deployments
                                            </h2>
                                            <div className="px-3 py-1 bg-red-500/10 text-red-500 rounded-full text-[10px] font-black">
                                                {inactiveTeams.length} UNITS
                                            </div>
                                        </div>
                                        <div className="grid gap-4">
                                            {inactiveTeams.map((team) => (
                                                ...
                                                >
                                                    <div className="flex items-center gap-6 relative z-10">
                                                        <div className={`w-12 h-12 rounded-2xl flex items-center justify-center font-black italic text-xl shadow-inner ${selectedTeam?.id === team.id ? 'bg-black text-red-500' : 'bg-black text-zinc-600'}`}>
                                                            {team.name[0]}
                                                        </div>
                                                        <div>
                                                            <h3 className="font-black italic uppercase text-lg leading-none tracking-tight">{team.name}</h3>
                                                            ...
                                                            {submissions.map((sub, idx) => (
                                                                <div key={sub.id} className="p-4 bg-black rounded-2xl border border-zinc-800">
                                                                    <div className="flex justify-between items-start mb-3">
                                                                        <span className="text-[10px] font-black text-emerald-500 uppercase tracking-widest">SUBMISSION RECORD</span>
                                                ...
                                                <div className="relative z-10">
                                                    ...
                                                    <div className="flex flex-wrap gap-4 items-center">
                                                        ...
                                                        <div className="ml-auto flex items-center gap-4">
                                                            {['judging', 'active'].includes(round.status) && (
                                                                <Link
                                                                    href={`/mentor/hackathons/${id}/rounds/${round.id}/judging`}
